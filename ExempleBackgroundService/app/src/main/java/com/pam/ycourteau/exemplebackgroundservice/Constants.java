...
package com.pam.ycourteau.exemplebackgroundservice;
...
public final class Constants {
    ...
    public static final String ACTION_VIEW_IMAGE =
            "com.pam.ycourteau.exemplebackgroundservice.ACTION_VIEW_IMAGE";

    public static final String ACTION_ZOOM_IMAGE =
            "com.pam.ycourteau.exemplebackgroundservice.ACTION_ZOOM_IMAGE";
    
    // Defines a custom Intent action
    public static final String BROADCAST_ACTION = "com.pam.ycourteau.exemplebackgroundservice.BROADCAST";

    // Fragment tags
    public static final String PHOTO_FRAGMENT_TAG =
            "com.pam.ycourteau.exemplebackgroundservice.PHOTO_FRAGMENT_TAG";
    
    public static final String THUMBNAIL_FRAGMENT_TAG =
            "com.pam.ycourteau.exemplebackgroundservice.THUMBNAIL_FRAGMENT_TAG";

    // Defines the key for the status "extra" in an Intent
    public static final String EXTENDED_DATA_STATUS = "com.pam.ycourteau.exemplebackgroundservice.STATUS";

    // Defines the key for the log "extra" in an Intent
    public static final String EXTENDED_STATUS_LOG = "com.pam.ycourteau.exemplebackgroundservice.LOG";
    
    // Defines the key for storing fullscreen state
    public static final String EXTENDED_FULLSCREEN =
            "com.pam.ycourteau.exemplebackgroundservice.EXTENDED_FULLSCREEN";
