...
public class DetecteurElectriqueFragment extends Fragment {
    ...
    public DetecteurElectriqueFragment(){
            ...
            if (resultant > EPSILON){
                ...
                if (mediaPlayer != null ) {
                    ...
                    mediaPlayer.release();
                        ...
                        mediaPlayer = MediaPlayer.create(getActivity().getApplicationContext(), R.raw.shock);
              ...
              if(!mediaPlayer.isPlaying()) {
                ...
                tv.setTextColor(Color.parseColor("#51BC3D"));
            }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_detecteurelectrique, container, false);
