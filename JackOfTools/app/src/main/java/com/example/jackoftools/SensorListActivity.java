 ...
 */
public class SensorListActivity extends AppCompatActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        android.support.v7.app.ActionBar.Tab tab = actionBar.newTab()
                ...
                .setTabListener(new com.example.jackoftools.TabListener<ArtistFragment>(this, "artist", ArtistFragment.class));
        actionBar.addTab(tab);

        tab = actionBar.newTab()
                .setText(R.string.album)
                .setTabListener(new com.example.jackoftools.TabListener<AlbumFragment>(this, "album", AlbumFragment.class));
        actionBar.addTab(tab);
